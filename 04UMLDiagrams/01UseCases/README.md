...
To pass the diagram into draw.io, open draw.io and use:

```text
Insert > Advanced > PlantUML
```

Then paste the content of `use-case-diagram.puml`. The rendered PNG in this
folder is only supporting evidence; the `.puml` file is the editable source.
