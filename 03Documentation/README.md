...
The current program is in:

- `../06Code/backend`
- `../06Code/frontend`

Older documentation may still mention `06Code/Model`, `06Code/View`, or `06Code/Controller`; those paths belong to a previous organization and are not the current physical layout.
