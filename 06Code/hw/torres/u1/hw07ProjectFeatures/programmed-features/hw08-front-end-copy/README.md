...
The frontend does not write directly to Supabase. Public enrollment, login, attendance check-in, class planning, attendance, finance, and event operations go through the backend.
